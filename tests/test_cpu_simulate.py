...
@pytest.mark.parametrize("force_use_type3", [True, False])
def test_simulate_gridded_type1_vs_type3(polarized, precision, shear_array, rotate_array, remove_antennas, ants, force_use_type3):
